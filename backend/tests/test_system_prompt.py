...
@pytest.mark.skip(reason="Fails because of the injection mechanism of the system prompt.")
@pytest.mark.xfail(reason="Fails because of the injection mechanism of the system prompt.")
def test_system_prompt()->None:
    """Checks the claimed system prompt is correct."""

    print(report_generator.prompt_templates["system_prompt"])
    assert DEFAULT_SYSTEM_PROMPT == report_generator.prompt_templates["system_prompt"]
