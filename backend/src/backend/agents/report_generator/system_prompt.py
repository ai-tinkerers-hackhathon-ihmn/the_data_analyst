...
Your job is to generate the code to build a dashboard to help the user analyze the data.
The code should comes as a python file that the user can copy and paste in a python file.
